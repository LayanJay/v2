...
const MovingBorderCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative z-20 bg-slate-900 sm:bg-slate-900/[0.1] border border-slate-800 backdrop-blur-2xl text-white flex items-center justify-center w-full h-full text-sm antialiased',
          className,
        )}
        style={{
